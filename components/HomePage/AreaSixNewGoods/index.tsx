                ...
                return (
                    <div className={styles.specialItem} key={i}>
                        ...
                        <ul className={`${styles.specialList} fcb`}>
                            <li className={styles.item} style={{ backgroundColor: rootCat.bgColor}}>
                                <a href="/goodsDetail" target={'_blank'}>
                                    <img src={rootCat.catImage} alt={rootCat.rootCatName} style={{ width:"210px",height:"210px",marginLeft:"calc((100% - 210px) / 2)" }} />
                                </a>
                            </li>
                                        ...
                                        <p className="priceWrap">
                                            {
                                                rootCat.simpleItemList[0].nowPrice && (
                                                    <span className="nowPrice" style={{margin:"0 10px",color:"#f33a3f"}}>¥519</span>
                                                )
                                            }
                                            {
                                                rootCat.simpleItemList[0].marketPrice && (
                                                    <span className="marketPrice" style={{textDecoration:"line-through",color:"#999999"}}>¥619</span>
                                                )
                                            }
                                        </p>
                                    </div>
